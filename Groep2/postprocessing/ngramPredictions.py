...
class pathBuilder():
    ...
    def buildDi(self, segmentOptions, ngram, actualWord = 'not given!'):
            ...
            for currentNode in level:
                ...
                for prevNode in levelArray[levelCount-1]:
                    ...
                    for topPic in prevNode[1]:
                        ...
                        # print topPic
                        # Build Tri gram
                        digram = "" + topPic[0][0][-1] + " " + currentNode[0][0][:]

                        probabilityFromStacking = normalisationValue * currentNode[0][1]
                        P = ngram.getProbability(digram) * probabilityFromStacking
    ...
    def runDi(self, segmentsOptions, ngram):
